from fcdft.wbl.uks import *
from pyscf import gto

'''
A simple example to run FC-DFT calculation with unrestricted Kohn-Sham method.
converged SCF energy = -721.608938661568  <S^2> = 2.1576365  2S+1 = 3.1033121
number of electrons (alpha, beta)= 36.0050000000002, 34.0050000000001
number of electrons (alpha+beta) = 70.0100000000003
optimized chemical potential (alpha, beta)= -2.83036274989784, -6.43588447305426 eV
'''
...
H        1.3390319419     -0.0095801980     -0.2157234144''',
        charge=0, spin=2, basis='6-31g**', verbose=5)
wblmf = WBLMoleculeUKS(mol, xc='pbe', broad=0.01, nelectron=70.01)
wblmf.kernel()
